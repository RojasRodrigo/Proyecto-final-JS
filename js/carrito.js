...
const pintarCarrito = () => {
    ...
    carrito.forEach((disfraz) => {
        ...
        modalProduct.innerHTML = `
            ...
            <p class="modalProductPrecio">Bs ${disfraz.precio}</p>
            ...
            <div class="modalProductTotal">
                ...
                <p class="modalProductTotalNumero">Bs ${disfraz.cantidad * disfraz.precio}</p>
            </div>
    ...
    <div class="modalFooterTotal">
        ...
        <p class="modalFooterTotalNumero">Bs ${total}</p>
    </div>
    <button class="modalFooterButton">
